...
A simple UNIX command interpreter written as part of the low-level programming and algorithm track at ALX Africa School.
...
This project was written as part of the curriculum for ALX School. ALX School is a non-campus-based full-stack software engineering program in Africa that prepares students(Africans) for careers in the tech industry using project-based peer learning. For more information, visit [this link](https://www.alx.com/).
